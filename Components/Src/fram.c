...
/**
 * Enables write opertaions on the FRAM by sending a Write Enable (WREN) command.
...
/**
 * Disables write opertaions on the FRAM by sending a Write Disable (WRDI) command.
 * @return ERR_OK if the command is successfully transmitted, otherwise the corresponding error code.
 */
