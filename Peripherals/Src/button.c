 ...
 * button.c
 *
 * Implementation for initializing and managing the Nucleo Board USER button for IWDG acknowledgment.
 */
...
{
    // Check for IWDG reset event and handle user acknowledgment
