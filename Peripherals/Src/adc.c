 ...
 * adc.c
 *
 *  Contains functions definitions required for ADC initialization and configuration
...
/**
 * Configures ADC1 for the internal temperature sensor measurement.
...
static void adc1_config(void)
{
    ...
    // Set the sampling time for the temperature sensor: 112 + 12 / 11.25 MHz = 11 microseconds
